...
export const PROJECTS: Project[] = [
  {
    ...
    caseStudy: {
      ...
      system: "An asynchronous execution runtime written in Rust and TypeScript that wraps model outputs in strict Zod/Pydantic schemas with an automatic zero-latency schema-repair loop.",
      architecture: "Client Request → Orchestrator Core → Worker Node → Schema Validator → Fallback Auto-Repair Loop → Deterministic Execution Engine → Database Persistence.",
      decisions: [
  ...
  },
  {
    ...
    caseStudy: {
      ...
      outcomes: "Delivered a 4x improvement in complex multi-file code refactoring reliability over single-pass LLM prompts with complete execution auditability.",
  ...
  },
  {
    ...
    caseStudy: {
      ...
      outcomes: "Achieved deterministic sub-millisecond processing latency with zero runtime heap allocations during continuous high-throughput data streams.",
