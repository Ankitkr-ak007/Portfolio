/**
 * Motion System Tokens for Level-1000 Engineering Portfolio
 * Built on Framer Motion / Motion v13 (motion/react)
 */

export const motionTokens = {
  // Spring Physics Configurations
  spring: {
    // Ultra-snappy micro-interactions (buttons, pills, indicators)
    snappy: { type: 'spring' as const, stiffness: 400, damping: 28, mass: 0.6 },
    // Default balanced spring for cards, modals, layout morphs
    default: { type: 'spring' as const, stiffness: 320, damping: 28, mass: 0.8 },
    // Gentle spring for camera parallax, custom cursor, smooth followers
    gentle: { type: 'spring' as const, stiffness: 180, damping: 24, mass: 1.0 },
    // High-inertia bouncy spring for celebratory or energetic triggers
